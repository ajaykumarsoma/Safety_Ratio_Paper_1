...
\begin{table}[h]
\centering
\caption{Cross-model SR behavior (L0/L2--4). Only Qwen2.5-1.5B shows significant Truth--Adversarial gap.}
...
\hline
Qwen2.5-1.5B & 0.350 & 0.322 & 0.028 & \textbf{0.005} \\
GPT-2 Small & 0.212 & 0.212 & 0.000 & 1.000 \\
GPT-2 Medium & 0.149 & 0.149 & 0.000 & 1.000 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Qwen2.5-1.5B layer ablation. Thresholds at 95th percentile of adversarial SR.}
...
\hline
L0 / L1--3 & 0.390 & 92\% & 72\% \\
L0 / L2--4 (ours) & 0.382 & \textbf{95\%} & 70\% \\
L0 / L3--5 & 0.375 & 90\% & 69\% \\
L1 / L2--4 & 0.405 & 88\% & 71\% \\
L0 / L4--6 & 0.365 & 86\% & 67\% \\
\hline
...
\begin{table}[h]
\centering
\caption{SR vs perplexity baseline at matched FPR ($\sim$70\%) on Qwen2.5-1.5B.}
...
\hline
Safety Ratio & SR $< 0.382$ & \textbf{95\%} & 70\% & 40\% \\
Perplexity & PPL $> 2.1$ & 44\% & 68\% & 31\% \\
\hline
\end{tabular}
\end{table}
